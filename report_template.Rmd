...
\fancyhead[L]{\raisebox{-0.05\height}{\includegraphics[height = 2.5cm]{"/genomic_report/ma-DPH_logo.png"}}}
\fancyhead[R]{\Huge MASPHL Genomic Clustering Report\\
\Large SARS-COV-2 Sequencing\\
...
if(nrow(snp_mat) > 35) tree_offset <- 40
if(nrow(snp_mat) > 35) row_offset <- -35
