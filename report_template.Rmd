...
### Sample Consensus Pass/Fail Status
...
columns <- c("sample", "coverage_after_trimming", "meanbaseq_trim", "meanmapq_trim", "assembly_status")
consensus_metrics <- status_table[, columns]

kable(consensus_metrics, 'latex', caption = 'Pass/Fail of Consensus Sequence Generation', booktabs = TRUE, linesep = '') %>%
